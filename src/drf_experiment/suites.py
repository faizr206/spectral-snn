...
VARIANT_UPDATES = {
    ...
    "gate_TopK2_SRG_fast": {
        "model": {
            "branch_readout": "weighted_sum",
            "freeze_dynamics_epochs": 2,
            "dynamics_lr_scale": 0.1,
            "smooth_reset": {"mode": "none", "beta": 0.0},
            "threshold": {"enabled": False},
            "stochastic": {"mode": "none"},
            "gating": {
                "mode": "spectral_response",
                "temperature": 0.5,
                "top_k": 2,
                "spectrum_norm": "sum",
                "detach_router": True,
        ...
        "training": {"amp": True, "eval_every": 3, "diagnostics_every": 3},
    },
    ...
    "hybrid_K3": {"model": {"hybrid_head": "mlp"}},
